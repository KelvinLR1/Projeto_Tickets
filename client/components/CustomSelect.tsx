...
export default function CustomSelect({
    ...
    return (
        <div className={clsx("space-y-3 relative", isOpen ? "z-20" : "z-10", className)} ref={containerRef}>
            {label && (
            ...
            <div className="relative">
                ...
                {isOpen && (
                    <div className="absolute top-[calc(100%+8px)] left-0 w-full bg-card/95 backdrop-blur-xl border border-border-theme rounded-2xl shadow-3xl z-[1000] overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
