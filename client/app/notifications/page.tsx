...
import { Bell, CheckCircle2, Info, AlertTriangle, Clock, X, Check, Search, Plus, Send, User, Ticket as TicketIcon, Reply, Trash2, Undo } from 'lucide-react';
...
export default function NotificationsPage() {
    ...
    const handleReply = (notif: any) => {
        ...
        setFormData({
            ...formData,
            recipient_user_id: notif.created_by_user_id, // Usar número diretamente para coincidir com value do CustomSelect
    ...
    return (
        <main className="min-h-screen p-8 bg-background text-foreground transition-all duration-500">
            <div className="max-w-4xl mx-auto space-y-10">
                    ...
                    <div className="flex gap-4">
                        ...
                        {unreadCount > 0 && (
                            <button
                                ...
                                className="flex items-center justify-center gap-3 px-8 py-4 rounded-2xl bg-white/5 border border-white/10 text-[10px] font-black uppercase tracking-widest hover:bg-white/10 transition-all active:scale-95"
                            >
                ...
                {/* Filters Tabs */}
                <div className="flex gap-2 p-1 bg-white/5 border border-border-theme rounded-2xl w-fit">
                ...
                <div className="space-y-4">
                    {filteredNotifications.length === 0 ? (
                        <div className="glass-card p-20 rounded-3xl border border-border-theme flex flex-col items-center justify-center text-center space-y-4 opacity-50">
            ...
            {showSendModal && (
                <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
                    <div className="bg-card w-full max-w-lg rounded-3xl border border-border-theme shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200 text-foreground">
